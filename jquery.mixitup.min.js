...
a.layoutMode=multiOut.layoutMode,a.filter=multiOut.filter,k(multiOut.filter,multiOut.sort,multiOut.order,g,a))})},remix:function(c){return this.each(function(){var a=this.config,g=e(this);a.origOrder=[];g.find(a.targetSelector).each(function(){var c=e(this);c.addClass("mix_all");a.origOrder.push(c)});!a.mixing&&"undefined"!==typeof c&&(e(a.filterSelector).removeClass("active"),e(a.filterSelector+'[data-filter="'+c+'"]').addClass("active"),"all"==c&&(c="mix_all"),a.filter=c,k(c,null,null,g,a))})}};
e.fn.mixitup=function(c,a){if(w[c])return w[c].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof c||!c)return w.init.apply(this,arguments)};e.fn.removeStyle=function(c){return this.each(function(){var a=e(this);c=c.replace(/\s+/g,"");var g=c.split(",");e.each(g,function(){var c=RegExp(this.toString()+"[^;]+;?","g");a.attr("style",function(a,e){if(e)return e.replace(c,"")})})})};Array.prototype.compare=function(c){if(this.length!=c.length)return!1;for(var a=0;a<c.length;a++)if(this[a].compare&&
!this[a].compare(c[a])||this[a]!==c[a])return!1;return!0}})(jQuery);